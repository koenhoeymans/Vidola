...
<?php if ($document->previousPageUrl()) { ?>
            <li><a href="<?php echo $document->previousPageUrl();
    ?>">previous</a></li>
  			<li class="divider-vertical"></li>
<?php } ?>

<?php if ($document->nextPageUrl()) { ?>
            <li><a href="<?php echo $document->nextPageUrl();
    ?>">next</a></li>
  			<li class="divider-vertical"></li>
<?php } ?>
...
<?php } ?>
        ...
        <div class="span9">
          <ul class="breadcrumb">
        		...
        		<li><a href="<?php echo $document->getPageUrl($page);
    ?>"><?php echo $document->getPageTitle($page);
    ?></a>
      ...
      <footer>
        <p class="pull-right">build with <a href="https://github.com/koenhoeymans/Vidola">Vidola</a></p>
      </footer>
