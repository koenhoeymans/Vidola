...
class Vidola_Processor_Processors_EmailObfuscatorTest extends PHPUnit_Framework_TestCase
{
	public function setup()
	{
		$this->processor = new \Vidola\Processor\Processors\EmailObfuscator();
	}
