...
class Vidola_Patterns_LinkDefinitionTest extends PHPUnit_Framework_TestCase
{
	/**
	 * @test
	 */
	...
	{
		$linkDef = new \Vidola\Patterns\LinkDefinition('name', 'url');
	...
	{
		$linkDef = new \Vidola\Patterns\LinkDefinition('name', 'url', 'title');
