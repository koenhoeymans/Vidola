...
class Vidola_Patterns_sectionTest extends PHPUnit_Framework_TestCase
{
	public function setup()
	{
		$this->pattern = new \Vidola\Patterns\SpecialSection('section:', 'section');
	}
...
another paragraph";
	...
	{
		$section = new \Vidola\Patterns\SpecialSection('section:', 'section', 'section');
