...
class Vidola_Pattern_Patterns_ManualHtmlTest extends \Vidola\UnitTests\Support\PatternReplacementAssertions
{
	public function setup()
	{
		$this->pattern = new \Vidola\Pattern\Patterns\ManualHtml();
	}
